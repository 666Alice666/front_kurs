...
window.addRecord = function (button) {
...
window.editRecord = function (recordItem){
...
window.saveEditedRecord = function (button, recordId, str_date) {
  const modal = button.closest('.modal');
...
window.addGoal = function (button) {
  const modal = button.closest('.modal');
...
window.addPhoto = function (button){
  const modal = button.closest('.modal');
